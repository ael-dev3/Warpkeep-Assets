# Asset catalog snapshot — 2026-09-08

This catalog preserves the showcase and package descriptions from the
[README at `3cbb481`](https://github.com/ael-dev3/Warpkeep-Assets/blob/3cbb4818c8eef037a80177a27df73940bcb73f3e/README.md).
It retains the original release dates, quantities, supplied QA statements,
asset identities, preview galleries and provenance links. References to
"current" or "this patch" belong to those historical descriptions.

The [current archive guide](../../README.md) explains collection navigation and
Warpkeep 0.4 context. Package records do not establish present game integration
or a fresh independent test run. Original prose and linked materials retain
their [recorded terms](../../LICENSE) and [per-set scope](../../ASSET-LICENSES.md).
Commands and code-formatted source paths below are relative to the repository root.
