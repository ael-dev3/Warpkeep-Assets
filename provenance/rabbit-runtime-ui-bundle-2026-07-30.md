...
- UI alpha audit: 3,089,642 transparent, 248,197 partial, 856,465 opaque pixels; matches supplied manifest.
- Runtime designation: visual-only; gameplay authority false; current integration not asserted.
- License boundary: public archive/release distribution authorized by Ael; no separate open-license grant asserted.
